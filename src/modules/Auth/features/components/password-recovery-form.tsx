...
export function PasswordResetForm() {
  ...
  return (
    <div className="w-[50%]">
      ...
      Enter registered email address of your account and we’ll send
      ...
      <div className="border-border border p-8 mt-8 rounded-2xl">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <div className="flex justify-center items-center text-xl text-secondary-foreground  font-OpenSans mt-4"><h3>Back to</h3><Button asChild  variant="link" className="px-2 text-blue"><Link to="/login"  className="text-xl ">Sign In</Link></Button></div>
          </form>
