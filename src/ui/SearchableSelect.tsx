    ...
    <div className="relative">
      ...
      >
        {data.map(({ value, label }) => (
          <option value={value} className="bg-white cursor-default select-none items-center rounded-sm py-1.5 pl-2 pr-8 text-lg outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50">
            {label}
          </option>
        ))}
      </select>
